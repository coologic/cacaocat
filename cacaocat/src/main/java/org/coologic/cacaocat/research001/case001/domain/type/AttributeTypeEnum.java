...
public enum AttributeTypeEnum {
    SOURCE_FILE("SourceFile", "ClassFile", null),
    ...
    METHOD_PARAMETERS("MethodParameters", "method_info", null),
    ...
    LINE_NUMBER_TABLE("LineNumberTable", "Code", null),
    LOCAL_VARIABLE_TABLE("LocalVariableTable", "Code", null),
