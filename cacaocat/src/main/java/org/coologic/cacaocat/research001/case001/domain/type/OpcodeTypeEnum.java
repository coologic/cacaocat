...
public enum OpcodeTypeEnum {
    ...
    LCMP(148, "lcmp", OperandTypeEnum.ZERO_OPERAND, InstructionTypeEnum.ARITHMETIC, "比较指令"),
    FCMPL(149, "fcmpl", OperandTypeEnum.ZERO_OPERAND, InstructionTypeEnum.ARITHMETIC, "比较指令"),
    FCMPG(150, "fcmpg", OperandTypeEnum.ZERO_OPERAND, InstructionTypeEnum.ARITHMETIC, "比较指令"),
    DCMPL(151, "dcmpl", OperandTypeEnum.ZERO_OPERAND, InstructionTypeEnum.ARITHMETIC, "比较指令"),
    DCMPG(152, "dcmpg", OperandTypeEnum.ZERO_OPERAND, InstructionTypeEnum.ARITHMETIC, "比较指令"),
